...
{
    [Header("Keys")]
    public int keyCount = 0; //!< The amount of keys that have been collected so far.
    ...
    [HideInInspector] public int keyCountForAchievement = 0; //!< An integer that counts up when collected the correct next key.
