...
/*! \brief A script that invokes a function to certain scripts on trigger enter.
 *
 *  Independent
 */
public class InvokeFromFunction : MonoBehaviour
{
    [Header("Invoke")]
    ...
    /*!
     *  A method that is triggered from another script.
     */
    public void Invoke()
    {
        if (activated) { return; }
